...
package com.basic.myjavaservice.controller;

import com.basic.myjavaservice.MyJavaService;
...
public class MyJavaController {
    ...
    public int add(@RequestParam(value = "a", required = false) int a, @RequestParam(value = "b", required = false) int b) {
        return myJavaService.add(a, b);
    }
